...
class CommercialVehicleController extends Controller
{
    ...
    public function store(CommercialVehicleStoreRequest $request)
    {
        ...
        try {
            if ($request->hasFile("driver_license_image")) {
                $path = $request
                    ->file("driver_license_image")
                    ->store("commercial_vehicles", "public");
            ...
            $vehicle_manufacturer =
                $commercial_vehicle->vehicle_manufacturer->name;
            ...
            return response()->json([
                "status" => "success",
                "message" =>
                    "Commercial vehicle has been enumerated successfully.",
    ...
    public function update(CommercialVehicleUpdateRequest $request, string $id)
    {
        ...
        try {
            ...
            return response()->json([
                "status" => "success",
                "message" =>
                    "Commercial vehicle enumeration has been updated successfully.",
                "data" => new CommercialVehicleResource($commercial_vehicle),
            ]);
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function show_by_user_id(string $user_id_or_unique_id)
    {
        ...
        $commercial_vehicles = CommercialVehicle::where(
            "user_id",
            $user->id
        )->get();
        ...
        return response()->json([
            ...
            "data" => CommercialVehicleResource::collection(
                $commercial_vehicles
            ),
        ]);
    }
    ...
    public function search(Request $request)
    {
        ...
        if ($request->has("vehicle_id")) {
            ...
            $individual_registrations = CommercialVehicle::where(
                "vehicle_id",
                $query_request
            )->paginate($per_page);
        }
        ...
        if ($request->has("date_from") && $request->has("date_to")) {
            ...
            $individual_registrations = CommercialVehicle::whereBetween(
                "created_at",
                [$date_from, $date_to]
            )->paginate($per_page);
        }
